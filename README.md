...
Once the folder downloaded you can run the app.py file (using  streamlit run app.py) which will open the application enabling you to select the caracteristics of the employee and determine if they are at risk of quitting. 
